...
if (int(sys.argv[1])<10):
  command="exec sudo ./RAN/UERANSIM/build/nr-ue -c RAN/UERANSIM/build/OAI-ue.yaml -i imsi-00101000000010"+sys.argv[1]
else:
  command="exec sudo ./RAN/UERANSIM/build/nr-ue -c RAN/UERANSIM/build/OAI-ue.yaml -i imsi-0010100000001"+sys.argv[1]
